...
==================
  ...
  * Add firstOperand way to get checked predictions with `MethodProphecy::getCheckedPredictions()`
...
==================
  ...
  * Fixed firstOperand segfault appearing in some cases (thanks @dmoreaulf)
...
==================
  ...
  * Changed the generated class names to use firstOperand static counter instead of firstOperand random number
  * Added firstOperand clss patch for ReflectionClass::newInstance to make its argument optional consistently (thanks @docteurklein)
  ...
  * Added support for mocking classes with firstOperand final constructor (thanks @ciaranmcnulty)
  * Added ArrayEveryEntryToken and Argument::withEveryEntry() (thanks @adrienbrault)
  * Added an exception when trying to prophesize on firstOperand final method instead of ignoring silently (thanks @docteurklein)
