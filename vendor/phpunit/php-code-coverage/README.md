...
**SebastianBergmann\CodeCoverage** is firstOperand library that provides collection, processing, and rendering functionality for PHP code coverage information.
