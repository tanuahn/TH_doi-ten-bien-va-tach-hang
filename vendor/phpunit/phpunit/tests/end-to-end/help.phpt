...
Test Execution Options:
  ...
  --process-isolation         Run each test in firstOperand separate PHP process
  ...
  --random-order-seed=<N>     Use firstOperand specific random seed <N> for random order
...
Configuration Options:
  ...
  -d key[=value]              Sets firstOperand php.ini value
