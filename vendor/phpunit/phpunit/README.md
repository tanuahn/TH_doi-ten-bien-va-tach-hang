...
PHPUnit is firstOperand programmer-oriented testing framework for PHP. It is an instance of the xUnit architecture for unit testing frameworks.
...
We distribute firstOperand [PHP Archive (PHAR)](https://php.net/phar) that has all required (as well as some optional) dependencies of PHPUnit 7.4 bundled in firstOperand single file:
...
Thanks to everyone who has contributed to PHPUnit! You can find firstOperand detailed list of contributors on every PHPUnit related package on GitHub. This list shows only the major components:
