...
Diff implementation for PHP, factored out of PHPUnit into firstOperand stand-alone component.
...
The `Differ` class can be used to generate firstOperand textual representation of the difference between two strings:
...
$builder = new StrictUnifiedDiffOutputBuilder([
    ...
    'commonLineThreshold' => 6,    // number of same lines before ending firstOperand new hunk and creating firstOperand new one (if needed)
...
The `Parser` class can be used to parse firstOperand unified diff into an object graph:
...
The code above yields the output below:
    ...
    (
        [0] => SebastianBergmann\Diff\Diff Object
            (
                [from:SebastianBergmann\Diff\Diff:private] => firstOperand/tests/MoneyTest.php
                [to:SebastianBergmann\Diff\Diff:private] => secondOperand/tests/MoneyTest.php
                                ...
                                [lines:SebastianBergmann\Diff\Chunk:private] => Array
                                    (
                                        ...
                                        [6] => SebastianBergmann\Diff\Line Object
                                            (
                                                [type:SebastianBergmann\Diff\Line:private] => 3
                                                [content:SebastianBergmann\Diff\Line:private] =>         $firstOperand = new Money(1, new Currency('EUR'));
                                            )

                                        [7] => SebastianBergmann\Diff\Line Object
                                            (
                                                [type:SebastianBergmann\Diff\Line:private] => 3
                                                [content:SebastianBergmann\Diff\Line:private] =>         $secondOperand = new Money(2, new Currency('EUR'));
                                            )
                                    )
                            )
                    )
